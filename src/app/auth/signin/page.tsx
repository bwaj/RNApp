      ...
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Track your Spotify listening habits and discover your music patterns
          </p>
        </div>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>
            By signing in, you agree to connect your Spotify account to track your music listening habits.
          </p>
        </div>
      </div>
    </div>
